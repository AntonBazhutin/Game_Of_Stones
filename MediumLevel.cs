...
namespace Игра
{
    public partial class MediumLevel : Form
    {
        ...
        private void MediumLevel_Load(object sender, EventArgs e)
        {
            ...
            totalCountOfStones = random.Next(89, 97);
        ...
        private void CheckCountOfStones(int totalCountOfStones, int currentCountOfStonesInFirstHeap, int currentCountOfStonesInSecondHeap)
        {
            if (currentCountOfStonesInFirstHeap + currentCountOfStonesInSecondHeap == totalCountOfStones)
            {
                if (isCreated == false)
                {
                    GameTimer.Stop();
        ...
        private void BtnPlus_Click(object sender, EventArgs e)
        {
            ...
            CheckCountOfStones(totalCountOfStones, currentCountOfStonesInFirstHeap, currentCountOfStonesInSecondHeap);
        ...
        private void TurnTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (MyTurn == false)
            {
                ...
                int choiseOfHeap = random.Next(1, 2);
                if (choise == 1)
                {
                    if (choiseOfHeap == 1)
                    {
                ...
                if (choise == 3)
                {
                    if (choiseOfHeap == 1)
                    {
                        ...
                        else
                        {
                            ...
                            ChoiseOfHeap(choise, choiseOfHeap, ref currentCountOfStonesInFirstHeap, ref currentCountOfStonesInSecondHeap);
                        }
                    }
                    else
                    {
        ...
        private void ChoiseOfHeap(int choise, int choiseOfHeap, ref int currentCountOfStonesInFirstHeap, ref int currentCountOfStonesInSecondHeap)
        {
            if (choise == 1)
            {
                if (choiseOfHeap == 1)
